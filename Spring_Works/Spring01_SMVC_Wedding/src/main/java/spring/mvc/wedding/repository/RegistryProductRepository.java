...
public class RegistryProductRepository {
	...
	public int regSelectListCnt(String email) {
		return sqlSessionTemplate.selectOne("logMapper.regSelectListCnt", email);
	}
	...
	public List<SavedPointDTO> selectListSavedPoint(String email){
		return sqlSessionTemplate.selectList("logMapper.selectListSavedPoint", email);
	}
}