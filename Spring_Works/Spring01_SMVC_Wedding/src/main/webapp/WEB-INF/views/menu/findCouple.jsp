<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<h2 class="cursive" style="text-align: center;">Find Couple</h2> <br>
	
	<div style="text-align: center; color: black;">
		
		<form action="/wedding/findCouple" method="post">
			커플 이름&nbsp; : &nbsp;<input type="text" name="cName" style="height: 40px;"/> &nbsp; &nbsp; 
			결혼 날짜&nbsp; : &nbsp;<input type="date" name="weddingDay"/> &nbsp; &nbsp;
			<input type="submit" value="search" style="width: 100px; height: 40px;">
		</form>
	...
	<c:forEach var="each" items="${ findCouple }">
		...
		<c:choose>
			...
			<c:otherwise>
				<jsp:include page="registry/product/reg_Cart.jsp"/>
			</c:otherwise>
		</c:choose>	
