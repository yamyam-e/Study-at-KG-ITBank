	...
	<div style="height: 40px;position: relative;top: 35px;">
		<form action="/wedding/regProductSearch" class="form-inline">
			<div class="form-group">
				...
				<input type="hidden" name="category" value="주방가전">
			</div>
		</form>
		<div class="dropdown" style="position: relative; bottom: 33px; left: 1040px;">
			...
			<ul class="dropdown-menu">
				...
				<li><a href="/wedding/regProductOrderByPriceASC?category=주방가전">가격 오름차순</a></li>
				<li><a href="/wedding/regProductOrderByPriceDESC?category=주방가전">가격 내림차순</a></li>
				<li class="divider"></li>
				<li class="dropdown-header">이름순 보기</li>
				<li><a href="/wedding/regProductOrderByNameASC?category=주방가전">이름 오름차순</a></li>
				<li><a href="/wedding/regProductOrderByNameDESC?category=주방가전">이름 내림차순</a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="container">
	<div class="row">
		<c:forEach var="each" items="${ regDinningElectronic }">
			<div class="col-md-4">
