...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/spring06/resources/landingzero_334/css/styles.css"/>
  </head>
  <body>
    ...
    <header id="first">
        ...
        <video autoplay="autoplay" loop="loop" class="fillWidth fadeIn wow collapse in" data-wow-delay="0.5s" poster="https://s3-us-west-2.amazonaws.com/coverr/poster/Traffic-blurred2.jpg" id="video-background">
			<source src="/spring06/resources/video/video.mp4" type="video/mp4">
        </video>
    </header>
    ...
    <script src="/spring06/resources/landingzero_334/css/styles.css"></script>
  </body>
</html>