...
<meta charset="UTF-8"><title>Insert title here</title>
	<script type="text/javascript">
		function agree() {
			...
			aaa.action = "/curr01/j29_HW01.jsp";
			aaa.method = "post";
			aaa.submit();
		}
		function disagree(){
			var bbb = document.frm; 
			bbb.action = "/curr01/j29_HW.jsp";
			bbb.method = "post";
			bbb.submit();
			alert("약관에 동의해 주세요.");
		}
...
<body>
	...
	<%--
	 ...
	 --%>
	 <form name="frm">
	 <table class="a"  style="text-align: left">
		<tr>
		<textarea readonly="readonly" style="font-size: 50; border: 1px solid black; none; height: 500px; width: 493px;">
제 1 장 총 칙
제1조 목적
...
②회사는 전항의 규정에 의하여 서비스의 이용을 제한하거나 중지한 때에는 그 사유 및 제한기간등을 회원에게 알려야 합다.
...
본 약관은 2016년 10월 7일부터 적용됩니다. 단, 본 약관의 공지 시점으로부터 적용일 전일까지 기간 동안에 가입한 신규회원에 대해서는 회원 가입시부터 본 약관이 적용됩니다.
	 	...
	 	<tr>
	 	<td align="center">
	 		<input type="checkbox" name="agree" value="yes"/>위 약관에 동의 합니다.
	 		<input type="checkbox" name="agree" value="no"/>위 약관에 동의 하지 않습니다.
	 	</td>
	 	</tr>
	 	<tr>
	 	<td align ="center">
